...
function paragrafOlustur(arrtoBeSelected, callackCumleKur, callbackCumleDonustur,) {
  let requestedArr = callbackCumleDonustur(arrtoBeSelected, " ");
  let result = callackCumleKur(requestedArr[1], requestedArr[3], requestedArr[5], requestedArr[7], requestedArr[9]);
...
console.log(emojileriDonustur("Selam:) Nasılsın :D Bugünkü falan :p :P", emojiler));
